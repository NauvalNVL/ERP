...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('machine', function (Blueprint $table) {
            ...
            $table->string('track_capacity', 20)->nullable()->comment('Track Capacity (Y-Yes, N-No)');
            $table->boolean('track_option_yz')->default(false)->comment('Track Option: Y-Z/Track + Friends Auto Update');
            $table->boolean('track_option_bypass')->default(false)->comment('Track Option: N-Bypass F/Track');
