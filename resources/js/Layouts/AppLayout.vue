    ...
    <div class="flex-1 min-w-0 flex flex-col overflow-hidden">
      ...
      >
        <div class="px-4 sm:px-6 lg:px-8">
          <div
            class="flex items-center justify-between h-16 gap-3 flex-wrap sm:flex-nowrap"
          >
            <div class="flex items-center min-w-0 gap-2 flex-shrink">
              ...
              >
                <span class="sr-only">{{
                  sidebarStore.mobileOpen ? "Close sidebar" : "Open sidebar"
                }}</span>
                <i
                  class="fas text-xl"
                  :class="sidebarStore.mobileOpen ? 'fa-times' : 'fa-bars'"
                ></i>
              </button>
            ...
            >
              <div class="relative flex-1">
                ...
                <input
                  ...
                  @keydown.enter.prevent="navigateHighlighted()"
...
const highlightNext = () => {
  ...
  highlightedIndex.value = (highlightedIndex.value + 1) % filteredMenuRoutes.value.length;
};
const highlightPrev = () => {
  if (filteredMenuRoutes.value.length === 0) return;
