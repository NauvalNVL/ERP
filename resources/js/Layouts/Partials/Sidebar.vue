    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'Define Category', icon: 'fas fa-sitemap', route: '/material-management/system-requirement/inventory-setup/category' },
          { title: 'Define SKU', icon: 'fas fa-barcode', route: '/material-management/system-requirement/inventory-setup/sku' },
