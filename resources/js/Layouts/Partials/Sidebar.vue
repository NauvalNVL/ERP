<template>
  <div
    class="flex flex-col h-screen bg-gray-800 text-white animate-fadeIn overflow-hidden"
  >
    <!-- Header with animation -->
    <div class="px-4 py-3 border-b border-gray-700 relative z-10">
      <div class="flex items-center">
        <div
          class="w-10 h-10 rounded-full mr-3 overflow-hidden pulse flex items-center justify-center"
        >
          <img
            :src="logoSrc"
    ...
    <nav class="flex-grow px-2 py-4 space-y-2 overflow-y-auto sidebar-content">
      ...
      <div v-if="hasPermission('dashboard')" class="relative group">
        <Link
          ...
          :class="{
            'bg-blue-600 text-white font-semibold shadow-lg border-l-4 border-blue-300': isActive(
              '/dashboard'
            ),
          ...
          :style="
            isActive('/dashboard')
              ? 'background-color: #2563eb !important; color: white !important; border-left: 4px solid #93c5fd !important;'
              : ''
          "
          :title="`Current: ${currentPath} | Route: /dashboard | Active: ${isActive(
            '/dashboard'
          )}`"
        >
          ...
          <div
            ...
            class="ml-auto w-2 h-2 bg-blue-200 rounded-full animate-pulse"
          ></div>
        </Link>
      </div>
    ...
    <!-- User Profile & Logout -->
    <div
      class="border-t border-gray-700 p-4 sticky bottom-0 bg-gray-800 z-10 slide-in-up"
    >
...
const userInitial = computed(() =>
  user.value?.username ? user.value.username.charAt(0).toUpperCase() : "G"
);
...
const getPermissionKeyFromTitle = (title) => {
  const titleMap = {
    ...
    "View & Print Registered Manual Numbers Log":
      "view_print_registered_manual_numbers_log",
    ...
    "Obsolete/Unobsolete Customer Sales Tax Index":
    ...
    children: [
      {
        ...
        children: [
          {
            title: "Define Salesperson",
            icon: "fas fa-user-tie",
            route: "/sales-person",
          },
          {
            title: "Obsolete/Unobsolete Salesperson",
            icon: "fas fa-ban",
            route: "/sales-person/status",
          },
          { title: "Define Industry", icon: "fas fa-industry", route: "/industry" },
          {
            title: "Obsolete/Unobsolete Industry",
            icon: "fas fa-ban",
          ...
          {
            title: "Define Product Group",
            icon: "fas fa-boxes",
            route: "/product-group",
          },
          {
            title: "Obsolete/Unobsolete Product Group",
            icon: "fas fa-ban",
            route: "/product-group/status",
          },
          { title: "Define Product", icon: "fas fa-box", route: "/product" },
          {
            title: "Obsolete/Unobsolete Product",
            icon: "fas fa-ban",
          ...
          {
            title: "Obsolete/Unobsolete Product Design",
            icon: "fas fa-ban",
            route: "/product-design/status",
          },
          { title: "Define Scoring Tool", icon: "fas fa-cut", route: "/scoring-tool" },
          {
            title: "Obsolete/Unobsolete Scoring Tool",
            icon: "fas fa-ban",
            route: "/scoring-tool/status",
          },
          {
            title: "Define Paper Quality",
            icon: "fas fa-scroll",
            route: "/paper-quality",
          },
          {
            title: "Obsolete/Unobsolete Paper Quality",
            icon: "fas fa-ban",
            route: "/paper-quality/status",
          },
          {
            title: "Define Paper Flute",
            icon: "fas fa-layer-group",
            route: "/paper-flute",
          },
          {
            title: "Obsolete/Unobsolete Paper Flute",
            icon: "fas fa-ban",
            route: "/paper-flute/status",
          },
          {
            title: "Define Paper Size",
            icon: "fas fa-ruler-combined",
            route: "/paper-size",
          },
          {
            title: "Obsolete/Unobsolete Paper Size",
            icon: "fas fa-ban",
            route: "/paper-size/status",
          },
          { title: "Define Color Group", icon: "fas fa-palette", route: "/color-group" },
          {
            title: "Obsolete/Unobsolete Color Group",
            icon: "fas fa-ban",
            route: "/color-group/status",
          },
          { title: "Define Color", icon: "fas fa-fill-drip", route: "/color" },
          {
            title: "Obsolete/Unobsolete Color",
            icon: "fas fa-ban",
            route: "/color/status",
          },
          { title: "Define Finishing", icon: "fas fa-paint-roller", route: "/finishing" },
          {
            title: "Obsolete/Unobsolete Finishing",
            icon: "fas fa-ban",
            route: "/finishing/status",
          },
          {
            title: "Define Stitch Wire",
            icon: "fas fa-paperclip",
            route: "/stitch-wire",
          },
          {
            title: "Obsolete/Unobsolete Stitch Wire",
            icon: "fas fa-ban",
            route: "/stitch-wire/status",
          },
          { title: "Define Chemical Coat", icon: "fas fa-vial", route: "/chemical-coat" },
          {
            title: "Obsolete/Unobsolete Chemical Coat",
            icon: "fas fa-ban",
            route: "/chemical-coat/status",
          },
          {
            title: "Define Reinforcement Tape",
            icon: "fas fa-tape",
            route: "/reinforcement-tape",
          },
          {
            title: "Obsolete/Unobsolete Reinforcement Tape",
            icon: "fas fa-ban",
            route: "/reinforcement-tape/status",
          },
          {
            title: "Define Bundling String",
            icon: "fas fa-link",
            route: "/bundling-string",
          },
          {
            title: "Obsolete/Unobsolete Bundling String",
            icon: "fas fa-ban",
            route: "/bundling-string/status",
          },
          {
            title: "Define Wrapping Material",
            icon: "fas fa-box-open",
            route: "/wrapping-material",
          },
          {
            title: "Obsolete/Unobsolete Wrapping Material",
            icon: "fas fa-ban",
            route: "/wrapping-material/status",
          },
          {
            title: "Define Glueing Material",
            icon: "fas fa-vial",
            route: "/glueing-material",
          },
          {
            title: "Obsolete/Unobsolete Glueing Material",
            icon: "fas fa-ban",
            route: "/glueing-material/status",
          },
          { title: "Define Machine", icon: "fas fa-cogs", route: "/machine" },
          {
            title: "Obsolete/Unobsolete Machine",
            icon: "fas fa-ban",
            route: "/machine/status",
          },
          // View & Print Section
          {
            title: "View & Print Salesperson",
            icon: "fas fa-print",
            route: "/sales-person/view-print",
          },
          {
            title: "View & Print Industry",
            icon: "fas fa-print",
            route: "/industry/view-print",
          },
          { title: "View & Print Geo", icon: "fas fa-print", route: "/geo/view-print" },
          {
            title: "View & Print Product Group",
            icon: "fas fa-print",
            route: "/product-group/view-print",
          },
          {
            title: "View & Print Product",
            icon: "fas fa-print",
            route: "/product/view-print",
          },
          {
            title: "View & Print Product Design",
            icon: "fas fa-print",
            route: "/product-design/view-print",
          },
          {
            title: "View & Print Paper Quality",
            icon: "fas fa-print",
            route: "/paper-quality/view-print",
          },
          {
            title: "View & Print Paper Flute",
            icon: "fas fa-print",
            route: "/paper-flute/view-print",
          },
          {
            title: "View & Print Paper Size",
            icon: "fas fa-print",
            route: "/paper-size/view-print",
          },
          {
            title: "View & Print Scoring Tool",
            icon: "fas fa-print",
            route: "/scoring-tool/view-print",
          },
          {
            title: "View & Print Color Group",
            icon: "fas fa-print",
            route: "/color-group/view-print",
          },
          {
            title: "View & Print Color",
            icon: "fas fa-print",
            route: "/color/view-print",
          },
          {
            title: "View & Print Finishing",
            icon: "fas fa-print",
            route: "/finishing/view-print",
          },
          {
            title: "View & Print Stitch Wire",
            icon: "fas fa-print",
            route: "/stitch-wire/view-print",
          },
          {
            title: "View & Print Chemical Coat",
            icon: "fas fa-print",
            route: "/chemical-coat/view-print",
          },
          {
            title: "View & Print Reinforcement Tape",
            icon: "fas fa-print",
            route: "/reinforcement-tape/view-print",
          },
          {
            title: "View & Print Bundling String",
            icon: "fas fa-print",
            route: "/bundling-string/view-print",
          },
          {
            title: "View & Print Wrapping Material",
            icon: "fas fa-print",
            route: "/wrapping-material/view-print",
          },
          {
            title: "View & Print Glueing Material",
            icon: "fas fa-print",
            route: "/glueing-material/view-print",
          },
          {
            title: "View & Print Machine",
            icon: "fas fa-print",
      ...
      },
      {
        ...
        children: [
          {
            title: "Define Customer Group",
            icon: "fas fa-users",
            route: "/customer-group",
          },
          {
            title: "Obsolete/Reactive Customer Group",
            icon: "fas fa-user-clock",
            route: "/obsolete-reactive-customer-group",
          },
          {
            title: "Update Customer Account",
            icon: "fas fa-user-edit",
            route: "/update-customer-account",
          },
          {
            title: "Obsolete/Reactive Customer A/C",
            icon: "fas fa-user-clock",
            route: "/obsolete-reactive-customer-account",
          },
          {
            title: "Define Customer Alternate Address",
            icon: "fas fa-map-marked-alt",
            route: "/customer-alternate-address",
          },

          {
            title: "View & Print Customer Group",
            icon: "fas fa-list",
            route: "/customer-group/view-print",
          },
          {
            title: "View & Print Customer Account",
            icon: "fas fa-list",
            route: "/update-customer-account/view-print",
          },
          {
            title: "View & Print Customer Alternate Address",
            icon: "fas fa-list",
            route: "/customer-alternate-address/view-print",
          },
        ],
      },
      {
        ...
        children: [
          ...
          {
            title: "Obsolete & Reactive MC",
            icon: "fas fa-ban",
            route:
              "/sales-management/system-requirement/master-card/obsolete-reactive-mc",
          },
          {
            title: "View & Print MC",
            icon: "fas fa-print",
    ...
    children: [
      {
        ...
        children: [
          {
            title: "Define Vehicle Class",
            icon: "fas fa-layer-group",
            route: "/warehouse-management/delivery-order/setup/vehicle-class",
          },
          {
            title: "Obsolete/Unobsolete Vehicle Class",
            icon: "fas fa-ban",
            route:
              "/warehouse-management/delivery-order/setup/obsolete-unobsolete-vehicle-class",
          },
          {
            title: "Define Vehicle",
            icon: "fas fa-truck",
            route: "/warehouse-management/delivery-order/setup/vehicle",
          },
          {
            title: "Obsolete/Unobsolete Vehicle",
            icon: "fas fa-ban",
            route:
              "/warehouse-management/delivery-order/setup/obsolete-unobsolete-vehicle",
          },
          {
            title: "View & Print Vehicle",
            icon: "fas fa-print",
            route: "/warehouse-management/delivery-order/setup/vehicle/view-print",
          },
          {
            title: "View & Print Vehicle Class",
            icon: "fas fa-print",
      ...
      },
      {
        ...
        children: [
          {
            title: "Prepare Delivery Order (Multiple Item)",
            icon: "fas fa-file-invoice-dollar",
          ...
          },
          {
            ...
            icon: "fas fa-print",
            route:
              "/warehouse-management/delivery-order/do-processing/print-delivery-order",
          },
          {
            title: "Amend Delivery Order",
            icon: "fas fa-edit",
            route:
              "/warehouse-management/delivery-order/do-processing/amend-delivery-order",
          },
          {
            title: "Cancel Delivery Order",
            icon: "fas fa-times-circle",
            route:
              "/warehouse-management/delivery-order/do-processing/cancel-delivery-order",
          },
        ],
      },
    ],
    ...
    children: [
      {
        ...
        children: [
          {
            title: "Define Tax Type",
            icon: "fas fa-percent",
            route: "/warehouse-management/invoice/setup/define-tax-type",
          },
          {
            title: "Obsolete/Unobsolete Tax Type",
            icon: "fas fa-ban",
            route: "/warehouse-management/invoice/setup/obsolete-unobsolete-tax-type",
          },
          {
            title: "Define Tax Group",
            icon: "fas fa-layer-group",
            route: "/warehouse-management/invoice/setup/define-tax-group",
          },
          {
            title: "Obsolete/Unobsolete Tax Group",
            icon: "fas fa-ban",
            route: "/warehouse-management/invoice/setup/obsolete-unobsolete-tax-group",
          },
          {
            title: "Define Customer Sales Tax Index",
            icon: "fas fa-user-tag",
            route: "/warehouse-management/invoice/setup/define-customer-sales-tax-index",
          },
          {
            title: "Obsolete/Unobsolete Customer Sales Tax Index",
            icon: "fas fa-ban",
            route:
              "/warehouse-management/invoice/setup/obsolete-unobsolete-customer-sales-tax-index",
          },
          {
            title: "View & Print Tax Type",
            icon: "fas fa-print",
            route: "/warehouse-management/invoice/setup/print-tax-type",
          },
          {
            title: "View & Print Tax Group",
            icon: "fas fa-print",
            route: "/warehouse-management/invoice/setup/print-tax-group",
          },
          {
            title: "View & Print Customer Sales Tax Index",
            icon: "fas fa-print",
            route: "/warehouse-management/invoice/setup/print-customer-sales-tax-index",
          },
        ],
      },
      {
