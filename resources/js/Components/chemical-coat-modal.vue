		...
		<div class="bg-white rounded-lg shadow-lg w-full max-w-4xl max-h-[90vh] flex flex-col">
			...
			<div class="p-5 flex-1 flex flex-col min-h-0">
				...
				<div class="mt-4 flex items-center justify-end space-x-3">
					...
					<button type="button" @click="selectAndClose(selectedCoat)" class="px-4 py-2 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white text-sm rounded-lg transform active:translate-y-px">
