    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-4xl">
      ...
      <div class="p-5">
          ...
          <table class="w-full divide-y divide-gray-200 table-auto min-w-max">
            ...
            <tbody class="bg-white divide-y divide-gray-200 text-xs">
              <tr v-for="machine in filteredMachines" :key="machine.machine_code || machine.id"
                :class="['hover:bg-blue-50 cursor-pointer', selectedMachine && selectedMachine.machine_code === machine.machine_code ? 'bg-blue-100 border-l-4 border-blue-500' : '']"
        ...
        <div class="mt-4 grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2">
          ...
          <button type="button" @click="selectAndClose(selectedMachine)" :disabled="!selectedMachine" class="py-2 px-3 bg-blue-500 hover:bg-blue-600 text-white text-xs rounded-lg transform active:translate-y-px disabled:opacity-50 disabled:cursor-not-allowed">
