<template>
  <transition name="fade">
    <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      <div class="bg-white rounded-lg shadow-2xl w-full max-w-5xl mx-auto relative animate-fade-in-up">
        <!-- Modal Header -->
        <div class="bg-gradient-to-r from-teal-500 to-green-600 p-4 rounded-t-lg shadow-md flex items-center justify-between">
        ...
        <div class="p-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-lg shadow-inner border border-gray-200">
              ...
              <div class="flex">
                <input type="text" id="search" v-model="searchQuery" placeholder="Search MCS#" class="flex-grow px-3 py-2 border border-gray-300 rounded-l-md shadow-sm focus:ring-blue-500 focus:border-blue-500" />
                <button @click="performSearch" class="px-4 py-2 bg-blue-600 text-white font-medium rounded-r-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-sm">
                  Search
                </button>
              </div>
            </div>
        ...
        <!-- Modal Footer -->
        <div class="bg-gray-100 px-4 py-3 sm:px-6 flex justify-end rounded-b-lg">
