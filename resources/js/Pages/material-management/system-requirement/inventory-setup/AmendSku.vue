  ...
  <AppLayout :header="'Amend SKU#'">
    ...
    <div class="bg-white rounded-b-lg shadow-md p-6 mb-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <p class="mt-2 text-sm text-gray-500">
                The new SKU code must be unique and follow the standard format.
              </p>
            </div>
      ...
      <div class="flex justify-end gap-4">
        ...
        >
          <i class="fas fa-save mr-2"></i> Update SKU Code
        </button>
      </div>
    </div>
    ...
    <Modal :show="showConfirmModal" @close="showConfirmModal = false">
      ...
      <template #body>
        ...
        <div v-if="reason === 'merge'" class="mt-2 p-3 bg-blue-50 rounded-md">
          <p class="text-sm text-blue-700">
            <strong>Merge Operation:</strong> This will combine data from SKU <strong>{{ selectedSku?.sku }}</strong> and 
        ...
        <p v-if="notes" class="mt-2 text-sm text-gray-500">
...
const confirmUpdateSku = async () => {
  ...
  try {
    ...
    toast.error(`Failed to change SKU code: ${error.response?.data?.message || error.message}`);
  } finally {
