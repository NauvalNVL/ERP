<template>
  <AppLayout :header="'Define Category'">
    <Head title="Define Category" />

    <!-- Header Section -->
    <div class="bg-gradient-to-r from-blue-600 to-blue-800 p-6 rounded-t-lg shadow-md">
      <h2 class="text-2xl font-bold text-white mb-2 flex items-center">
        <i class="fas fa-list-alt mr-3"></i> Define Category
      </h2>
      <p class="text-blue-100">Define product categories for inventory management</p>
    </div>
        ...
        <div class="flex-1">
          ...
          <div class="mb-6 flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
            ...
            <div class="flex gap-2 w-full md:w-auto">
              ...
              <Link href="/material-management/system-requirement/inventory-setup/category/view-print" class="btn-info flex-1 md:flex-none">
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  <tr v-else-if="filteredCategories.length === 0" class="hover:bg-gray-50">
                    <td colspan="2" class="px-6 py-4 text-center text-sm text-gray-500">
                      No categories found. Click "New Category" to create one or use "Seed Data" to generate sample data.
                    </td>
                  </tr>
          ...
          <div class="mt-4 flex justify-between items-center text-sm text-gray-600">
            <div>
              <span>Showing {{ paginatedCategories.length }} of {{ filteredCategories.length }} categories</span>
            </div>
        ...
        <div class="w-full md:w-96 bg-gray-50 rounded-lg p-4 border border-gray-200">
          <div v-if="selectedCategory" class="mb-6">
            <h3 class="text-lg font-semibold text-gray-800 mb-3 flex items-center">
              <i class="fas fa-info-circle mr-2 text-blue-500"></i> Category Details
            </h3>
            <div class="space-y-3">
              <div class="flex justify-between border-b border-gray-200 pb-2">
                <span class="text-gray-600">Code:</span>
                <span class="font-medium text-gray-900">{{ selectedCategory.code }}</span>
              </div>
              <div class="flex justify-between border-b border-gray-200 pb-2">
          ...
          <div v-else class="flex flex-col items-center justify-center h-64 text-center">
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-1">No Category Selected</h3>
...
const fetchCategories = async () => {
  ...
  try {
    ...
    if (selectedCategory.value) {
      const updated = categories.value.find(c => c.code === selectedCategory.value.code);
      if (updated) {
...
// Watch for changes in filtered categories
