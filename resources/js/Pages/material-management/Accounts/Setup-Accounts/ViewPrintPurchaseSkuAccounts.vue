      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg shadow-lg p-6 mb-6">
          <div class="flex items-center justify-between">
            <div>
              <h1 class="text-2xl font-bold text-white">View & Print Purchase SKU Accounts</h1>
              <p class="text-blue-100 mt-1">View and generate reports for Purchase SKU Accounts</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
          <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900">Purchase SKU Accounts</h3>
          </div>
...
const header = 'View & Print Purchase SKU Accounts'
const title = 'View & Print Purchase SKU Accounts - ERP System'
...
const filteredData = computed(() => {
  let filtered = skuAccounts.value
...
const generateReport = async () => {
  loading.value = true
  try {
    const response = await fetch('/api/material-management/account/setup-account/generate-purchase-sku-report', {
      method: 'POST',
      headers: {
