<template>
  <AppLayout :header="header">
    <div class="max-w-7xl mx-auto">
      <!-- Header Section -->
      <div class="bg-white rounded-lg shadow-lg p-6 mb-6 border-l-4 border-indigo-500">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-gray-600 mt-2">View and print receipt transaction logs</p>
          </div>
...
const loadTransactions = async () => {
  try {
    ...
    const response = await axios.get('/api/rc-rt/rc-transactions', { params })
...
const exportToExcel = async () => {
  try {
    ...
    if (response.data.success) {
      ...
      a.href = url
      a.download = `RC_Log_${new Date().toISOString().split('T')[0]}.xlsx`
