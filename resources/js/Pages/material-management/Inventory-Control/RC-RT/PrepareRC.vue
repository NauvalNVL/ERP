      ...
      <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-lg p-6 mb-6 text-white">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-blue-100 mt-2 text-lg">Create new receipt transactions for inventory management</p>
          </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value="RC"
                  class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-blue-50 text-blue-700 font-medium"
                  readonly
                />
              </div>
          ...
          <div class="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
            ...
            <div class="space-y-3">
              ...
              <div class="flex justify-between items-center">
                ...
                <span class="text-sm font-bold text-green-600">{{ formatCurrency(totalAmount) }}</span>
              </div>
              <div class="flex justify-between items-center">
...
const header = 'Prepare Receipt (RC)'
...
const saveTransaction = async () => {
  ...
  try {
    ...
    if (response.data.success) {
      success('RC transaction saved successfully')
...
const printTransaction = () => {
  ...
  printWindow.document.write(`
    <html>
      <head>
        <title>RC Transaction - ${form.value.transaction_number}</title>
        <style>
...
const exportTransaction = () => {
  ...
  // Create CSV export
  const csvContent = [
    ['Transaction Number', 'Date', 'Supplier', 'SKU', 'Quantity', 'Amount'],
    [form.value.transaction_number, form.value.transaction_date, form.value.supplier_name, form.value.sku_code, form.value.quantity, totalAmount.value]
  ...
  a.href = url
  a.download = `RC_${form.value.transaction_number}.csv`
  a.click()
