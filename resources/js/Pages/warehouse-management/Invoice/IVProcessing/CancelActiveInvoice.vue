<template>
    <AppLayout :header="'Cancel Active Invoice'">
        <!-- Header -->
        <div class="bg-gradient-to-r from-red-600 via-pink-600 to-rose-600 text-white shadow-lg rounded-t-lg border border-red-700">
            <div class="px-4 py-3 sm:px-6 flex items-center gap-3">
                <div class="h-9 w-9 rounded-full bg-red-500 flex items-center justify-center">
                    <i class="fas fa-times-circle text-white text-lg"></i>
                </div>
                <div>
                    <h2 class="text-lg sm:text-xl font-semibold leading-tight">Cancel Active Invoice</h2>
                    <p class="text-xs sm:text-sm text-red-100">Cancel existing active invoices with reason</p>
                </div>
            </div>
        </div>
