    ...
    <AppLayout :header="pageHeader">
        ...
        <div class="bg-gradient-to-r from-green-600 to-green-700 p-6 rounded-t-lg shadow-lg mb-6">
            <h2 class="text-2xl font-bold text-white mb-2 flex items-center">
                ...
                Manage Tax Group Status (Obsolete/Unobsolete)
            </h2>
            <p class="text-emerald-100">Toggle the active status of tax groups.</p>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 bg-white">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Sales Tax Applied</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        >
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ item.sales_tax_applied }}</td>
                        ...
                        <tr v-if="filteredTaxGroups.length === 0">
                            <td colspan="5" class="px-6 py-4 text-center text-gray-500">No tax groups found.</td>
                        </tr>
                    </tbody>
                </table>
            </div>

            <!-- Loading Overlay for toggling -->
            <div
                v-if="isToggling"
