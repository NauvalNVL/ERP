          ...
          <div class="px-4 py-3 sm:px-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs sm:text-sm text-blue-100">
                Preview and print tax type master data.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              >
                <div class="flex items-center">
                  ...
                  <div>
                    <h2 class="text-base font-semibold">TAX TYPE LIST</h2>
                    <p class="text-xs opacity-90">Sales tax type master data</p>
                  </div>
                </div>
              </div>
              ...
              >
                <div class="flex items-center justify-between">
                  <div>Total: {{ filteredTaxTypes.length }}</div>
                  <div v-if="searchQuery" class="text-xs">
                    Filtered from {{ taxTypes.length }}
                  </div>
