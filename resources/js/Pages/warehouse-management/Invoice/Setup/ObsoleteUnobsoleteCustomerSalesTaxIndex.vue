                    ...
                    <div class="px-4 py-3 sm:px-6 flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-lg sm:text-xl font-semibold leading-tight">
                                Manage Customer Sales Tax Index Status
                            </h2>
                            <p class="text-xs sm:text-sm text-blue-100">
                                Toggle active/obsolete status of customer tax indices.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto rounded-lg border border-gray-200">
                        <table class="min-w-full divide-y divide-gray-200 bg-white">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-4 py-3 text-left text-xs font-semibold text-slate-700 uppercase tracking-wider">Customer Code</th>
                                    <th class="px-4 py-3 text-left text-xs font-semibold text-slate-700 uppercase tracking-wider">Index#</th>
                                    <th class="px-4 py-3 text-left text-xs font-semibold text-slate-700 uppercase tracking-wider">Tax Group</th>
                                    <th class="px-4 py-3 text-left text-xs font-semibold text-slate-700 uppercase tracking-wider">Tax Group Name</th>
                                    <th class="px-4 py-3 text-center text-xs font-semibold text-slate-700 uppercase tracking-wider">Status</th>
                                    <th class="px-4 py-3 w-40 text-center text-xs font-semibold text-slate-700 uppercase tracking-wider">Action</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-100">
                                ...
                                >
                                    <td class="px-4 py-3 whitespace-nowrap text-sm font-mono text-slate-900">{{ item.customer_code }}</td>
                                    <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-slate-900">{{ formatIndex(item.index_number) }}</td>
                                    <td class="px-4 py-3 whitespace-nowrap text-sm font-mono text-slate-700">{{ item.tax_group_code }}</td>
                                    <td class="px-4 py-3 whitespace-nowrap text-sm text-slate-700">{{ item.tax_group?.name || '' }}</td>
                                ...
                                <tr v-if="filteredIndices.length === 0">
                                    <td colspan="6" class="px-4 py-8 text-center text-slate-500 text-sm">No customer tax indices found.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
