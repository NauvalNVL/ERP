    ...
    <AppLayout :header="pageHeader">
        ...
        <div class="bg-gradient-to-r from-green-600 to-green-700 p-6 rounded-t-lg shadow-lg mb-6">
            <h2 class="text-2xl font-bold text-white mb-2 flex items-center">
                ...
                Manage Tax Type Status (Obsolete/Unobsolete)
            </h2>
            <p class="text-emerald-100">Toggle the active status of tax types.</p>
        </div>
            ...
            <div class="overflow-x-auto rounded-lg border border-gray-200 shadow-sm">
                <table class="min-w-full divide-y divide-gray-200 bg-white">
                    <thead class="bg-gray-100">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tax Code</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tax Name</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Apply</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Rate (%)</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Custom Type</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        >
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ item.apply }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ Number(item.rate ?? 0).toFixed(2) }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ item.custom_type || 'N-NIL' }}</td>
                        ...
                        <tr v-if="filteredTaxTypes.length === 0">
                            <td colspan="7" class="px-6 py-4 text-center text-gray-500">No tax types found.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
