<template>
    <AppLayout :header="'Print FG Stock-In Log'">
        <!-- Header Section -->
        <div class="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 p-6 rounded-t-lg shadow-lg overflow-hidden relative">
            <!-- Decorative Elements -->
            ...
            <div class="flex items-center">
                <div class="bg-gradient-to-br from-green-500 to-emerald-600 p-3 rounded-lg shadow-inner flex items-center justify-center relative overflow-hidden mr-4">
                    ...
                    <i class="fas fa-file-alt text-white text-2xl z-10"></i>
                </div>
                <div>
                    <h2 class="text-2xl md:text-3xl font-bold text-white mb-1 text-shadow">Print FG Stock-In Log</h2>
                    <p class="text-green-100 max-w-2xl">View and print finished goods stock-in transaction logs</p>
                </div>
            </div>
        </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-green-500 mb-6">
                        ...
                        <form @submit.prevent="searchTransactions" class="space-y-4">
                            ...
                            <div>
                                <label for="reference" class="block text-sm font-medium text-gray-700 mb-1">Reference/SO Number:</label>
                                <input
                                    type="text"
                                    id="reference"
                                    v-model="filters.reference"
                                    placeholder="Enter reference or SO number"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                                />
                            </div>
                            ...
                            <div class="flex justify-end pt-4">
                                ...
                                <button
                                    type="submit"
                                    class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md text-sm shadow-md"
                                >
                                    Search
                                </button>
                            </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-teal-500">
                        <div class="flex items-center mb-6 pb-2 border-b border-gray-200">
                            <div class="p-2 bg-gradient-to-r from-teal-500 to-green-600 rounded-lg mr-3 shadow-md">
                        ...
                        <div class="space-y-4">
                            <button
                                @click="printReport"
                                class="w-full flex items-center justify-center px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white rounded-md shadow-md"
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-emerald-500 mb-6">
                        <div class="flex items-center justify-between mb-6 pb-2 border-b border-gray-200">
                            <div class="flex items-center">
                                ...
                                <h3 class="text-lg font-semibold text-gray-800">Stock-In Transaction Log</h3>
                            </div>
                            <div class="text-sm">
                        ...
                        <div id="printable-area" class="print-section">
                            <div class="print-header mb-6">
                                <h2 class="text-xl font-bold text-center">Finished Goods Stock-In Log</h2>
                            ...
                            <div>
                                <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                    ...
                                    <button
                                        ...
                                        :class="page === pagination.current_page ? 'z-10 bg-green-50 border-green-500 text-green-600' : 'bg-white border-gray-300 text-gray-500 hover:bg-gray-50'"
...
const searchTransactions = async () => {
    try {
        ...
        const response = await axios.get('/api/reports/fg-stock-in-log', {
            params: {
