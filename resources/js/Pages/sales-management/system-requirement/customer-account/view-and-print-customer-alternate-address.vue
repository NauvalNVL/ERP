                ...
                <div class="flex items-start md:items-center space-x-4 mb-4 md:mb-0">
                  ...
                  <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-white text-shadow">
                      View & Print Customer Alternate Addresses
                    </h1>
                    <p class="text-teal-100 max-w-2xl">
                      Preview and print customer alternate address data
                    </p>
                  </div>
                </div>
            ...
            <div class="flex items-center">
              ...
              <div>
                ...
                <p class="text-xs text-cyan-100 opacity-80">
                  Filter customer alternate addresses by various criteria
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="flex items-center">
              ...
              <div>
                ...
                <p class="text-sm opacity-80">
                  View and manage customer alternate address information
                </p>
              </div>
            </div>
          </div>
