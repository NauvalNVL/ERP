        ...
        >
            <div class="max-w-7xl mx-auto">
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        ></div>
                                        <i
                                            class="fas fa-print text-white text-2xl z-10"
                                        ></i>
                                    </div>
                                    <div>
                                        <h1
                                        ...
                                        <p class="text-teal-100 max-w-2xl">
                                            Preview and print customer account
                                            data
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm opacity-80">
                                    View and manage customer account data
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <i
                                                    class="fas fa-users text-4xl text-gray-300 mb-2"
                                                ></i>
                ...
                >
                    ...
                    >
                        <i class="fas fa-info-circle mr-2"></i> PDF Export
                        Instructions
                    </h3>
                    <ul class="list-disc pl-5 text-sm text-gray-600 space-y-1">
                        <li>
                            Click the "Print PDF" button above to generate and
                            download PDF
                        </li>
                        <li>
                            PDF will be automatically saved in landscape
                            orientation
                        </li>
                        <li>
                            You can search, filter by status, or sort data
                            before exporting
                        </li>
                        <li>
                            PDF includes formatted table with headers and page
                            numbers
                        </li>
                    </ul>
                </div>
...
const filteredCustomerAccounts = computed(() => {
    ...
    if (statusFilter.value !== "all") {
        filtered = filtered.filter(
            (account) => account.status === statusFilter.value
        );
    }
