<template>
  <AppLayout :header="'View & Print MC by P/Size P/Quality'">
    <Head title="View & Print MC by P/Size P/Quality" />
              ...
              <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div class="flex items-start md:items-center space-x-4 mb-4 md:mb-0">
                  <div class="bg-gradient-to-br from-pink-500 to-purple-600 p-3 rounded-lg shadow-inner flex items-center justify-center relative overflow-hidden">
                    ...
                    <i class="fas fa-layer-group text-white text-2xl z-10 animate-pulse"></i>
                  </div>
                  <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-white text-shadow">View & Print MC by P/Size P/Quality</h1>
                    <p class="text-blue-100 max-w-2xl">Search and print master cards filtered by paper size and quality</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form @submit.prevent="searchRecords">
              ...
              <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                    <div class="mr-2 w-7 h-7 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full shadow-md flex items-center justify-center">
                      <i class="fas fa-scroll text-white text-sm animate-pulse-light"></i>
                    </div>
                    Check P/Quality:
                  </label>
                  <div class="flex flex-wrap gap-4 ml-9">
                    <div class="flex items-center">
                      <input
                        id="so-pquality"
                        type="checkbox"
                        v-model="searchParams.soQuality"
                        class="h-4 w-4 text-indigo-600 focus:ring-indigo-500"
                      />
                      <label for="so-pquality" class="ml-2 text-sm text-gray-700">SO P/Quality</label>
                    </div>
                    <div class="flex items-center">
                      <input
                        id="wo-pquality"
                        type="checkbox"
                        v-model="searchParams.woQuality"
                        class="h-4 w-4 text-indigo-600 focus:ring-indigo-500"
                      />
                      <label for="wo-pquality" class="ml-2 text-sm text-gray-700">W/O P/Quality</label>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-4">
                ...
                <div class="text-sm text-gray-600">
                  <p class="mb-2">Use this form to search and print master cards by paper size and quality:</p>
