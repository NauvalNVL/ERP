...
const selectMcs = (mcs) => {
    ...
    // As requested, populate the 'to' field.
    form.value.mcsTo = mcs.seq;
    
    // For better user experience, if the 'from' field is empty,
    // populate it with the same value. This allows for selecting a range.
    if (!form.value.mcs) {
