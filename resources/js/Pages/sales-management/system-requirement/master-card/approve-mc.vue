...
<template>
    <AppLayout :header="'Approve MC'">
        ...
        r from-purple-600 via-indigo-600 to-blue-600 p-6 rounded-t-lg shadow-lg overflow-hidden relative">
            <!-- Decorative Elements -->
        ...
        <div v-if="false && showMcsOptionsModal" class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto">
            <!-- Modal backdrop -->
        ...
        <div v-if="false && showMcsTableModal" class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto">
            <!-- Modal backdrop -->
                ...
                <div class="p-6 bg-gradient-to-br from-white via-blue-50 to-cyan-50 rounded-b-2xl overflow-auto" style="max-height: 440px;">
                    <div class="mb-4 flex flex-col md:flex-row justify-between items-center gap-4">
                        <div class="text-gray-700 text-base font-medium">
                            ...
                            <span class="text-gray-600">{{ mcsStatusFilter === 'all' ? 'All Records' : (mcsStatusFilter === 'Act' ? 'Active Records Only' : 'Obsolete Records Only') }}</span>
                        </div>
                    ...
                    <div v-if="mcsSortOption === 'part'" class="mt-4 p-4 border border-indigo-200 rounded-lg bg-white">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <input type="text" id="mcs-model" :value="selectedMcs?.model || ''" readonly class="flex-grow bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 focus:outline-none focus:border-blue-500 transition" />
                            </div>
                            <div></div> <!-- Spacer -->
                            <!-- External Dimensions -->
                            <div class="flex items-center gap-2">
                                ...
                                <div class="flex items-center gap-1">
                                    <input type="text" :value="selectedMcs?.ext_dim_1 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                                    <span>x</span>
                                    <input type="text" :value="selectedMcs?.ext_dim_2 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                                    <span>x</span>
                                    <input type="text" :value="selectedMcs?.ext_dim_3 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                                </div>
                            </div>
                            <!-- Internal Dimensions -->
                            <div class="flex items-center gap-2">
                                ...
                                <div class="flex items-center gap-1">
                                    <input type="text" :value="selectedMcs?.int_dim_1 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                                    <span>x</span>
                                    <input type="text" :value="selectedMcs?.int_dim_2 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                                    <span>x</span>
                                    <input type="text" :value="selectedMcs?.int_dim_3 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div v-if="false && showMcsOptionsModalTo" class="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto">
            <!-- Modal backdrop -->
            <div class="fixed inset-0 bg-black bg-opacity-50 transition-opacity" @click="showMcsOptionsModalTo = false"></div>
            ...
            <div class="relative bg-white rounded-lg shadow-xl w-96 mx-auto max-w-lg z-10 transform transition-all">
                ...
                <div class="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-t-lg relative overflow-hidden">
                    ...
                    <button type="button" @click="showMcsOptionsModalTo = false" 
                        class="text-white hover:text-gray-200 focus:outline-none transition-transform hover:scale-110 relative z-10 bg-red-500 bg-opacity-30 hover:bg-opacity-50 rounded-full w-8 h-8 flex items-center justify-center">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
        ...
        <div v-if="false && showMcsTableModalTo" class="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
          <!-- Modal content -->
            ...
            <div class="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-t-lg">
              ...
              <div class="flex space-x-3 items-center">
                <div class="text-white text-sm mr-2">
                  ...
                  <select class="bg-blue-700 text-white border border-blue-500 rounded px-1 py-0.5 text-xs">
                ...
                <div class="text-white text-sm mr-2">
                  ...
                  <select v-model="mcsSortOption" class="bg-blue-700 text-white border border-blue-500 rounded px-1 py-0.5 text-xs">
                ...
                <div class="text-white text-sm mr-2">
                  ...
                  <select v-model="mcsSortOrder" class="bg-blue-700 text-white border border-blue-500 rounded px-1 py-0.5 text-xs">
                ...
                <div class="text-white text-sm">
                  ...
                  <select v-model="mcsRecordStatus.active" class="bg-blue-700 text-white border border-blue-500 rounded px-1 py-0.5 text-xs">
                    <option :value="true">Active</option>
                    <option :value="false">Obsolete</option>
                  </select>
                </div>
                <button type="button" @click="showMcsTableModalTo = false" class="text-white hover:text-gray-200 focus:outline-none">
                <i class="fas fa-times text-xl"></i>
              </button>
            </div>
                </div>
            ...
            <div class="p-2 overflow-y-auto flex-grow" style="max-height: 60vh;">
              ...
              <div class="overflow-x-auto rounded-lg shadow">
                <table class="min-w-full text-xs border border-gray-300">
                  <thead class="bg-gray-200 sticky top-0">
                    ...
                    <tr v-else-if="['seq', 'model'].includes(mcsSortOption)">
                      <th v-if="mcsSortOption !== 'model'" class="px-2 py-1 border border-gray-300 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">MC Seq#</th>
                      <th class="px-2 py-1 border border-gray-300 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">MC Model</th>
                      <th v-if="mcsSortOption === 'model'" class="px-2 py-1 border border-gray-300 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">MC Seq#</th>
                      <th class="px-2 py-1 border border-gray-300 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Status</th>
                    </tr>
                    <tr v-else-if="mcsSortOption === 'ed'">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <template v-if="mcsSortOption === 'part'">
                      <tr v-for="(mcs, index) in filteredMcsDataTo" :key="mcs.seq + '-part'"
                        ...
                        :class="{ 'bg-blue-200': selectedMcsTo?.seq === mcs.seq }"
                    ...
                    <template v-else-if="['seq', 'model'].includes(mcsSortOption)">
                      <tr v-for="(mcs, index) in filteredMcsDataTo" :key="mcs.seq + '-seqmodel'"
                        ...
                        @click="selectForViewMcsTo(mcs)"
                        @dblclick="selectMcsTo(mcs)">
                        <td v-if="mcsSortOption !== 'model'" class="px-2 py-1 border border-gray-300">{{ mcs.seq }}</td>
                    ...
                    <tr v-if="filteredMcsDataTo.length === 0">
                      <td :colspan="mcsSortOption === 'part' ? 5 : (['seq', 'model'].includes(mcsSortOption) ? 4 : (['ed','id'].includes(mcsSortOption) ? 6 : 5))" class="px-4 py-8 text-center text-gray-500 border-b border-gray-300 bg-white">
                        No master card records found matching your criteria
                      </td>
                    </tr>
                  </tbody>
              ...
              <div v-if="mcsSortOption === 'part'" class="mt-4 p-4 border border-indigo-200 rounded-lg bg-white">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                  <!-- Model -->
                  <div class="flex items-center gap-2">
                    <label for="mcs-model-to" class="font-bold w-24">Model:</label>
                    <input type="text" id="mcs-model-to" :value="selectedMcsTo?.model || ''" readonly class="flex-grow bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 focus:outline-none focus:border-blue-500 transition" />
                  </div>
                  <div></div> <!-- Spacer -->
                  <!-- External Dimensions -->
                  <div class="flex items-center gap-2">
                    <label class="font-bold w-24">Ext. Dim:</label>
                    <div class="flex items-center gap-1">
                      <input type="text" :value="selectedMcsTo?.ext_dim_1 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                      <span>x</span>
                      <input type="text" :value="selectedMcsTo?.ext_dim_2 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                      <span>x</span>
                      <input type="text" :value="selectedMcsTo?.ext_dim_3 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                    </div>
                  </div>
                  <!-- Internal Dimensions -->
                  <div class="flex items-center gap-2">
                    <label class="font-bold w-24">Int. Dim:</label>
                    <div class="flex items-center gap-1">
                      <input type="text" :value="selectedMcsTo?.int_dim_1 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                      <span>x</span>
                      <input type="text" :value="selectedMcsTo?.int_dim_2 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                      <span>x</span>
                      <input type="text" :value="selectedMcsTo?.int_dim_3 || ''" readonly class="w-20 bg-gray-100 border-2 border-gray-300 rounded-md py-1 px-2 text-center focus:outline-none focus:border-blue-500 transition" />
                    </div>
                  </div>
                </div>
              </div>
...
const filteredCustomers = computed(() => {
    return customerData.value.filter(customer => {
        ...
        if (recordStatusFilter.value.obsolete && customer.status === 'Obsolete') {
            return true;
        }
        return false;
    });
...
const fetchMcsData = async () => {
    try {
        ...
        const statuses = mcsStatusFilter.value === 'all' ? ['Act','Obsolete'] : [mcsStatusFilter.value];
        statuses.forEach(s => params.append('status[]', s));
        params.set('per_page', '10');
        params.set('page', String(mcsCurrentPage.value));
        const res = await fetch(`/update-mc/master-cards?${params.toString()}`, { headers: { 'Accept': 'application/json' } });
...
const selectCustomer = (customer) => {
    ...
    searchTerm.value = customer.code; // Update the search term with selected customer code
