<template>
    ...
    <div class="bg-gradient-to-r from-green-600 to-green-700 p-6 rounded-t-lg shadow-lg">
        ...
        <p class="text-emerald-100">Define industries for customer and product categorization</p>
    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                        <div class="col-span-2">
                            ...
                            <div class="relative flex">
                                ...
                                <input type="text" v-model="industryCode" @input="searchIndustryCode" @keyup.enter="handleSearchAndCreate" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 transition-colors" placeholder="Enter industry code">
                        ...
                        <div class="col-span-1">
                            ...
                            <button type="button" @click="createNewIndustry" class="w-full flex items-center justify-center px-4 py-2 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white rounded">
