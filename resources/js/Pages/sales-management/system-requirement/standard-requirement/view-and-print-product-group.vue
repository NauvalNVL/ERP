<template>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex justify-between items-center mb-6 print:hidden">
            <h1 class="text-2xl font-semibold text-gray-700">View & Print Product Groups</h1>
        ...
        <div v-else class="bg-white shadow-md rounded-lg overflow-hidden">
            <table class="min-w-full leading-normal">
                <thead class="bg-gray-100">
                    <tr>
                        <th @click="sortTable('product_group_id')" class="px-5 py-3 border-b-2 border-gray-200 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer">
                            Group ID <i :class="getSortIcon('product_group_id')"></i>
                        </th>
                        <th @click="sortTable('product_group_name')" class="px-5 py-3 border-b-2 border-gray-200 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer">
                ...
                <tbody>
                    <tr v-for="group in filteredProductGroups" :key="group.product_group_id" class="hover:bg-gray-50">
...
const filteredProductGroups = computed(() => {
    ...
    if (searchQuery.value) {
        ...
        filtered = filtered.filter(group => 
            (group.product_group_id && group.product_group_id.toLowerCase().includes(query)) ||
