    ...
    <div class="min-h-screen bg-gray-50 py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-emerald-600 text-white shadow-sm rounded-xl border border-emerald-700 mb-4">
            <div class="px-4 py-3 sm:px-6 flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-lg sm:text-xl font-semibold leading-tight">View & Print Scoring Tool</h2>
                    <p class="text-xs sm:text-sm text-emerald-100">Preview and print scoring tool data</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-wrap items-center justify-between mb-6">
            <div class="flex items-center space-x-2 mb-3 sm:mb-0">
                ...
                <Link href="/scoring-tool" class="bg-gray-100 hover:bg-gray-200 text-gray-800 px-4 py-2 rounded-md flex items-center space-x-2 border border-gray-200">
