<template>
  <AppLayout :header="'Define Machine'">
          ...
          <div class="px-4 py-3 sm:px-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs sm:text-sm text-green-100">
                Define machines for production processes. Use machine codes to control
            ...
            <div class="lg:col-span-2">
              ...
              >
                <div class="flex items-center mb-6 pb-2 border-b border-gray-200">
                  ...
                  <h3 class="text-xl font-semibold text-gray-800">Machine Management</h3>
                </div>
                ...
                <div v-else class="mt-4 bg-green-100 p-3 rounded">
                  <p class="text-sm font-medium text-green-800">
                    Data available: {{ machines.length }} machines found.
                  </p>
                  <p v-if="selectedRow" class="text-xs text-green-700 mt-1">
                    Selected:
                    <span class="font-semibold">{{ selectedRow.machine_code }}</span> -
                    {{ selectedRow.machine_name }} ({{ selectedRow.status }})
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="lg:col-span-1">
              ...
              >
                <div class="flex items-center mb-4 pb-2 border-b border-gray-200">
                  ...
                  <h3 class="text-lg font-semibold text-gray-800">Machine Info</h3>
                </div>
    ...
    >
      <div
        class="bg-white rounded-xl shadow-lg border border-gray-200 w-11/12 md:w-2/5 max-w-md mx-auto"
      >
        <div
          class="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-emerald-600 text-white rounded-t-xl"
        >
          <div class="flex items-center">
            ...
            <h3 class="text-sm font-semibold">
              {{ isCreating ? "Create Machine" : "Edit Machine" }}
            </h3>
          </div>
          <button
            type="button"
          ...
          <form @submit.prevent="saveMachineChanges" class="space-y-4">
            <div class="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <select
                    v-model="editForm.resource_type"
                    class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500 text-sm"
                  >
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <select
                    v-model="editForm.finisher_type"
                    class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500 text-sm"
                  >
            ...
            <div class="flex justify-between mt-6 pt-4 border-t border-gray-200">
              <button
                type="button"
                v-if="!isCreating"
                @click="deleteMachine(editForm.id)"
...
const deleteMachine = async (id) => {
  const confirmRes = await Swal.fire({
    title: 'Obsolete Machine?',
    text: 'Are you sure you want to obsolete this machine?',
    icon: 'warning',
