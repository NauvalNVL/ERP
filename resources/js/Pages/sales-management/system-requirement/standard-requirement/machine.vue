        ...
        <div class="max-w-6xl mx-auto">
            <div class="bg-gradient-to-r from-green-600 to-green-700 text-white shadow-sm rounded-xl border border-green-700 mb-4">
                <div class="px-4 py-3 sm:px-6 flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg sm:text-xl font-semibold leading-tight">Define Machine</h2>
                        <p class="text-xs sm:text-sm text-green-100">Define machines for production processes. Use machine codes to control production resources.</p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm border-t-4 border-teal-500 mb-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="p-4 bg-blue-50 rounded-lg">
                                    <h4 class="text-sm font-semibold text-blue-800 uppercase tracking-wider mb-2">Common Machines</h4>
                                    <div class="grid grid-cols-1 gap-2 text-sm">
                                        <div class="flex items-center min-w-0">
                                            <span class="w-6 h-6 flex items-center justify-center bg-blue-600 text-white rounded-full font-bold mr-2 shrink-0">PR</span>
                                            <span class="min-w-0 break-words">Printer</span>
                                        </div>
                                        <div class="flex items-center min-w-0">
                                            <span class="w-6 h-6 flex items-center justify-center bg-emerald-600 text-white rounded-full font-bold mr-2 shrink-0">DC</span>
                                            <span class="min-w-0 break-words">Diecutter</span>
                                        </div>
                                        <div class="flex items-center min-w-0">
                                            <span class="w-6 h-6 flex items-center justify-center bg-purple-600 text-white rounded-full font-bold mr-2 shrink-0">FG</span>
                                            <span class="min-w-0 break-words">Folder Gluer</span>
                                        </div>
                                        <div class="flex items-center min-w-0">
                                            <span class="w-6 h-6 flex items-center justify-center bg-yellow-500 text-white rounded-full font-bold mr-2 shrink-0">ST</span>
                                            <span class="min-w-0 break-words">Stitcher</span>
                                        </div>
                                        <div class="flex items-center min-w-0">
                                            <span class="w-6 h-6 flex items-center justify-center bg-green-600 text-white rounded-full font-bold mr-2 shrink-0">PK</span>
                                            <span class="min-w-0 break-words">Packing</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input v-model="editForm.machine_code" type="text" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-emerald-500 focus:border-emerald-500 text-sm" :class="{ 'bg-gray-100': !isCreating }" :readonly="!isCreating" required>
                            </div>
                        </div>
                        <div>
