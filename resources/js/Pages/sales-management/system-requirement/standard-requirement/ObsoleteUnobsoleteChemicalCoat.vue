      ...
      <div class="max-w-7xl mx-auto">
          ...
          <div class="px-4 py-3 sm:px-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xs sm:text-sm text-emerald-100">Activate or deactivate chemical coats quickly and easily.</p>
              </div>
            </div>
            ...
            <div class="relative w-full sm:w-72">
              ...
              <input
                v-model="searchQuery"
                type="text"
                placeholder="Cari chemical coat (code, name)..."
        ...
        <div class="bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden">
          <div class="px-4 py-2 sm:px-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-white">
            <div>
              <h2 class="text-sm font-semibold text-gray-800">Chemical Coat List</h2>
              <p class="text-xs text-gray-500">{{ filteredChemicalCoats.length }} of {{ chemicalCoats.length }} chemical coats</p>
            </div>
