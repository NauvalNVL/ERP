<template>
    ...
    <div class="bg-gradient-to-r from-cyan-700 to-blue-600 p-6 rounded-t-lg shadow-lg">
        ...
        <p class="text-cyan-100">Define geographical data for specific locations and areas</p>
    </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-blue-500">
                    ...
                    <div class="flex items-center space-x-2 mb-6">
                        ...
                        <button type="button" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded flex items-center space-x-2" @click="editSelectedGeo">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button type="button" class="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded flex items-center space-x-2" @click="createNewGeo">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                        <div class="col-span-2">
                            ...
                            <div class="relative flex">
                                ...
                                <input type="text" v-model="geoCode" @input="searchGeoCode" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none border border-gray-300 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                        ...
                        <div class="col-span-1">
                            ...
                            <button type="button" @click="editSelectedGeo" class="w-full flex items-center justify-center px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded">
                    ...
                    <div v-else-if="geos.length === 0" class="mt-4 bg-yellow-100 p-3 rounded">
                        ...
                        <div class="mt-2 flex items-center space-x-3">
                            <button @click="fetchGeos" class="bg-blue-500 hover:bg-blue-600 text-white text-xs px-3 py-1 rounded">Reload Data</button>
                        </div>
                    </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-purple-500">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        ...
                        <Link href="/finishing" class="flex items-center p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                            ...
                            <div>
                                <p class="font-medium text-blue-900">Finishing</p>
                                <p class="text-xs text-blue-700">Manage finishing methods</p>
                            </div>
                        </Link>

                        <Link href="/vue/geo/view-print" class="flex items-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                            <div class="p-2 bg-green-500 rounded-full mr-3">
                                <i class="fas fa-print text-white text-sm"></i>
                            </div>
                            <div>
                                <p class="font-medium text-green-900">Print List</p>
                                <p class="text-xs text-green-700">Print geo list</p>
                            </div>
                        </Link>
                    </div>
                </div>
                ...
                <form @submit.prevent="reviewGeoData" class="space-y-4">
                    ...
                    <div class="flex justify-between mt-6 pt-4 border-t border-gray-200">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Review</button>
                        </div>
                    </div>
                </form>
            </div>
...
const saveGeoData = async () => {
    ...
    try {
        ...
        let url = isCreating.value ? '/geo' : `/geo/${editForm.value.code}`;
...
const deleteGeo = async () => {
    ...
    try {
        ...
        const response = await fetch(`/geo/${editForm.value.code}`, {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': csrfToken,
                'Accept': 'application/json'
