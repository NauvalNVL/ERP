                ...
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-blue-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <button type="button" @click="createNewglueingMaterial" class="w-full flex items-center justify-center px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded transition-colors transform active:translate-y-px">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-purple-500">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        ...
                        <Link href="/glueing-material/view-print" class="flex items-center p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                            <div class="p-2 bg-purple-500 rounded-full mr-3">
                                <i class="fas fa-print text-white text-sm"></i>
                            </div>
                            <div>
                                <p class="font-medium text-purple-900">Print List</p>
                                <p class="text-xs text-purple-700">Print Glueing Material list</p>
                            </div>
                        </Link>
                    </div>
                </div>
