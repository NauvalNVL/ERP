            ...
            <div class="bg-emerald-600 text-white shadow-sm rounded-xl border border-emerald-700 mb-4">
                <div class="px-4 py-3 sm:px-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <div class="flex items-center gap-2 text-xs text-emerald-100">
                        ...
                        <span>Use color codes to manage product color definitions.</span>
                    </div>
                </div>
            </div>
                ...
                <div class="lg:col-span-2 space-y-4">
                    <div class="bg-white shadow-sm rounded-xl border border-gray-200">
                        <div class="px-4 py-3 sm:px-6 border-b border-gray-100 flex items-center">
                            ...
                            <div>
                                <h3 class="text-sm sm:text-base font-semibold text-slate-800">Define Color</h3>
                                <p class="text-xs text-slate-500">Search, create, and maintain your colors.</p>
                            </div>
                        </div>
                        <div class="px-4 py-4 sm:px-6">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <div class="relative flex">
                                        ...
                                        <input
                                            ...
                                            placeholder="Search or type color code"
                                        >
                                        <button
                                            type="button"
                            ...
                            <div v-else-if="colors.length === 0" class="mt-3 bg-amber-50 border border-amber-200 p-3 rounded-lg">
