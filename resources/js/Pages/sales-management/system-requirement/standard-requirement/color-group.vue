<template>
    ...
    <div class="bg-gradient-to-r from-green-600 to-green-700 p-6 rounded-t-lg shadow-lg">
        ...
        <p class="text-emerald-100">Define color groups for production and inventory management</p>
    </div>
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-emerald-500 mb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 bg-emerald-50 rounded-lg">
                            <h4 class="text-sm font-semibold text-emerald-800 uppercase tracking-wider mb-2">CG Types</h4>
                            <div class="grid grid-cols-1 gap-2 text-sm">
                                ...
                                <div class="flex items-center">
                                    <span class="w-6 h-6 flex items-center justify-center bg-emerald-500 text-white rounded-full font-bold mr-2 text-xs">X</span>
                                    <span>X-Flexo</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <Link href="/color" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-emerald-700">Manage individual colors</p>
                            </div>
                        </Link>

                        <a href="/finishing" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors">
                            <div class="p-2 bg-emerald-500 rounded-full mr-3">
                                <i class="fas fa-th-list text-white text-sm"></i>
                            </div>
                            <div>
                                <p class="font-medium text-emerald-900">Finishings</p>
                                <p class="text-xs text-emerald-700">Manage finishings</p>
                            </div>
                        </a>
