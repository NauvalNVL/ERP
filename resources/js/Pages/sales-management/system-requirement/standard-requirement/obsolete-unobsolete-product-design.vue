<template>
    ...
    <div class="bg-gradient-to-r from-green-600 to-green-700 p-6 rounded-t-lg shadow-lg mb-6">
        <h2 class="text-2xl font-bold text-white mb-2 flex items-center">
            <i class="fas fa-sync-alt mr-3"></i> Manage Product Design Status (Obsolete/Unobsolete)
        </h2>
        <p class="text-emerald-100">Toggle the active status of product designs.</p>
    </div>
...
const fetchProductDesigns = async (page = 1) => {
    ...
    try {
        const response = await fetch(`/api/product-designs?page=${page}`, {
            headers: {
