                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-lg sm:text-xl font-semibold leading-tight">
                                Define Reinforcement Tape
                            </h2>
                            <p class="text-xs sm:text-sm text-emerald-100">
                                Manage reinforcement tape definitions for production.
                            </p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2 text-xs text-emerald-100">
                        <i class="fas fa-info-circle text-sm"></i>
                        <span>Use reinforcement tape codes for corrugator dry-end configuration.</span>
                    </div>
                </div>
            </div>
                ...
                <div class="lg:col-span-2 space-y-4">
                    <div class="bg-white shadow-sm rounded-xl border border-gray-200">
                        <div class="px-4 py-3 sm:px-6 border-b border-gray-100 flex items-center">
                            ...
                            <div>
                                <h3 class="text-sm sm:text-base font-semibold text-slate-800">Define Reinforcement Tape</h3>
                                <p class="text-xs text-slate-500">Search, create, and maintain your reinforcement tapes.</p>
                            </div>
                        </div>
                        <div class="px-4 py-4 sm:px-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div class="col-span-2">
                                    <label class="block text-sm font-semibold text-slate-700 mb-1">Reinforcement Tape Code</label>
                                    <div class="relative flex">
                                        ...
                                        <input
                                            ...
                                            placeholder="Search or type reinforcement tape code"
                                        >
                                        <button
                                            type="button"
                                ...
                                <div class="col-span-1">
                                    ...
                                    <button
                                        type="button"
                                        @click="createNewReinforcementTape"
                            ...
                            <div v-if="loading" class="mt-3 bg-amber-50 border border-amber-200 p-3 rounded-lg flex items-center space-x-3 text-sm">
                                <div class="flex items-center">
                                    ...
                                    <p class="font-medium text-amber-800">Loading reinforcement tape data...</p>
                                </div>
                            </div>
                            <div v-else-if="reinforcementTapes.length === 0" class="mt-3 bg-amber-50 border border-amber-200 p-3 rounded-lg">
                                <p class="text-sm font-semibold text-amber-800">No reinforcement tape data available.</p>
                            ...
                            <div v-else class="mt-3 bg-emerald-50 border border-emerald-200 p-3 rounded-lg">
                                <p class="text-sm font-semibold text-emerald-800">Data available: {{ reinforcementTapes.length }} reinforcement tapes found.</p>
                ...
                <div class="lg:col-span-1 space-y-4">
                    ...
                    <div class="bg-white shadow-sm rounded-xl border border-emerald-100">
                        <div class="px-4 py-3 sm:px-5 border-b border-emerald-100 flex items-center">
                            ...
                            <h3 class="text-sm sm:text-base font-semibold text-emerald-900">Reinforcement Tape Info</h3>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="p-4 bg-sky-50 rounded-lg border border-sky-100">
                                    ...
                                    <div class="space-y-2 text-xs sm:text-sm">
                                        <div class="flex items-center">
                                            <span class="w-8 h-8 flex items-center justify-center bg-orange-500 text-white rounded-full font-bold mr-2">LS</span>
                                            <span>Lakban Serat</span>
                                        </div>
                                        <div class="flex items-center">
                                            <span class="w-8 h-8 flex items-center justify-center bg-emerald-500 text-white rounded-full font-bold mr-2">RT</span>
                                            <span>Reinforcement Tape</span>
                                        </div>
                                        <div class="flex items-center">
                                            <span class="w-8 h-8 flex items-center justify-center bg-green-500 text-white rounded-full font-bold mr-2">FT</span>
                                            <span>Fiber Tape</span>
                                        </div>
                                        <div class="flex items-center">
                                            <span class="w-8 h-8 flex items-center justify-center bg-emerald-600 text-white rounded-full font-bold mr-2">ST</span>
                    ...
                    <div class="bg-white shadow-sm rounded-xl border border-violet-100">
                        ...
                        <div class="px-4 py-4 sm:px-5">
                            <div class="grid grid-cols-1 gap-3">
                                <Link href="/stitch-wire" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors border border-emerald-100">
                                    <div class="p-2 bg-emerald-500 rounded-full mr-3">
                                        <i class="fas fa-paperclip text-white text-sm"></i>
                                    </div>
                                    <div>
                                        <p class="font-medium text-emerald-900 text-sm">Stitch Wire</p>
                                ...
                                <Link href="/reinforcement-tape/view-print" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors border border-emerald-100">
                                    <div class="p-2 bg-emerald-500 rounded-full mr-3">
                                        <i class="fas fa-print text-white text-sm"></i>
                                    </div>
                                    <div>
                                        <p class="font-medium text-emerald-900 text-sm">Print List</p>
                                        <p class="text-xs text-emerald-700">Print reinforcement tape list</p>
                                    </div>
                                </Link>
                            </div>
                        </div>
            ...
            <div class="p-5">
                <form @submit.prevent="saveReinforcementTapeChanges" class="space-y-4">
                    ...
                    <div class="flex justify-between mt-5 pt-4 border-t border-gray-200">
                        <button type="button" v-if="!isCreating" @click="deleteReinforcementTape(editForm.id)" class="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 text-sm font-medium">
