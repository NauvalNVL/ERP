<template>
    ...
    <div class="bg-gradient-to-r from-green-600 to-green-700 p-6 rounded-t-lg shadow-lg">
        <h2 class="text-2xl font-bold text-white mb-2 flex items-center">
            <i class="fas fa-tape mr-3"></i> Define Reinforcement Tape
        </h2>
        <p class="text-emerald-100">Manage reinforcement tape definitions for production</p>
    </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-blue-500">
                    <div class="flex items-center mb-6 pb-2 border-b border-gray-200">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800">Define Reinforcement Tape</h3>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <button type="button" @click="createNewReinforcementTape" class="w-full flex items-center justify-center px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded transition-colors transform active:translate-y-px">
            ...
            <div class="lg:col-span-1">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 bg-blue-50 rounded-lg">
                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                <div class="flex items-center">
                                    <span class="w-8 h-8 flex items-center justify-center bg-blue-500 text-white rounded-full font-bold mr-2">RT</span>
                                ...
                                <div class="flex items-center">
                                    <span class="w-8 h-8 flex items-center justify-center bg-purple-500 text-white rounded-full font-bold mr-2">ST</span>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-purple-500">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        ...
                        <Link href="/reinforcement-tape/view-print" class="flex items-center p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                            <div class="p-2 bg-purple-500 rounded-full mr-3">
                                <i class="fas fa-print text-white text-sm"></i>
                            </div>
                            <div>
                                <p class="font-medium text-purple-900">Print List</p>
                                <p class="text-xs text-purple-700">Print reinforcement tape list</p>
                            </div>
                        </Link>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-xl w-11/12 md:w-2/5 max-w-md mx-auto transform transition-transform duration-300">
            <div class="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-t-lg">
                <div class="flex items-center">
                    ...
                    <h3 class="text-xl font-semibold">{{ isCreating ? 'Create Reinforcement Tape' : 'Edit Reinforcement Tape' }}</h3>
                </div>
