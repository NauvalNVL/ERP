            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-emerald-500 mb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 bg-emerald-50 rounded-lg">
                            <h4 class="text-sm font-semibold text-emerald-800 uppercase tracking-wider mb-2">Common Types</h4>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-emerald-500">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        ...
                        <Link href="/reinforcement-tape/view-print" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors">
                            <div class="p-2 bg-emerald-500 rounded-full mr-3">
