<template>
    ...
    <div class="bg-gradient-to-r from-green-600 to-green-700 p-6 rounded-t-lg shadow-lg">
        ...
        <p class="text-emerald-100">Define flute thickness for corrugated cardboard</p>
    </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-emerald-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <button type="button" @click="createNewFlute" class="w-full flex items-center justify-center px-4 py-2 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white rounded">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-emerald-500 mb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 bg-emerald-50 rounded-lg">
                            <h4 class="text-sm font-semibold text-emerald-800 uppercase tracking-wider mb-2">Common Flutes</h4>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-emerald-500">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <Link href="/paper-size" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors">
                            <div class="p-2 bg-emerald-500 rounded-full mr-3">
                                <i class="fas fa-box text-white text-sm"></i>
                            </div>
                            <div>
                                <p class="font-medium text-emerald-900">Paper Size</p>
                                <p class="text-xs text-emerald-700">Manage paper sizes</p>
                            </div>
                        </Link>

                        <a href="/paper-quality" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors">
                            <div class="p-2 bg-emerald-500 rounded-full mr-3">
                ...
                <form @submit.prevent="saveFluteChanges" class="space-y-4">
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between gap-3 mt-6 pt-4 border-t border-gray-200">
                        ...
                        <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            ...
                            <button type="submit" class="w-full sm:w-auto px-4 py-2 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white rounded-lg transition-colors">
