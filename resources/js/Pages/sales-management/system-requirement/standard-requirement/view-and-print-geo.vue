<template>
    ...
    <div class="bg-gradient-to-r from-green-600 to-green-700 p-6 rounded-t-lg shadow-lg">
        ...
        <p class="text-emerald-100">Preview and print geographical data</p>
    </div>
    ...
    <div class="bg-white rounded-b-lg shadow-lg p-6 mb-6">
        ...
        <div class="flex flex-wrap items-center justify-between mb-6">
            <div class="flex items-center space-x-2 mb-3 sm:mb-0">
                ...
                <Link href="/geo" class="bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white px-4 py-2 rounded flex items-center space-x-2">
