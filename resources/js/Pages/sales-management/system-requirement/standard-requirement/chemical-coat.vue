                    ...
                    <div class="bg-white shadow-sm rounded-xl border border-violet-100">
                        ...
                        <div class="px-4 py-4 sm:px-5">
                            <div class="grid grid-cols-1 gap-3">
                                <Link href="/stitch-wire" class="flex items-center p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors border border-purple-100">
                                    <div class="p-2 bg-purple-500 rounded-full mr-3">
                                        <i class="fas fa-paperclip text-white text-sm"></i>
                                    </div>
                                    <div>
                                        <p class="font-medium text-purple-900 text-sm">Stitch Wire</p>
                                        <p class="text-xs text-purple-700">Manage stitch wire</p>
                                    </div>
                                </Link>
                                ...
                                <Link href="/chemical-coat/view-print" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors border border-emerald-100">
