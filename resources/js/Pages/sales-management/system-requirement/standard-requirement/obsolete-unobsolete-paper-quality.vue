                ...
                <div class="px-4 py-3 sm:px-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs sm:text-sm text-green-100">Activate or deactivate paper qualities quickly and easily.</p>
                        </div>
                    </div>
...
const fetchPaperQualities = async (page = 1) => {
    ...
    try {
        const response = await fetch(`/api/paper-qualities?page=${page}&all_status=1`, {
            headers: {
