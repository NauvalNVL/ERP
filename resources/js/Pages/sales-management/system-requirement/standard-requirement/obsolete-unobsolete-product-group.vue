<template>
    ...
    <div class="bg-gradient-to-r from-green-600 to-green-700 p-6 rounded-t-lg shadow-lg mb-6">
        <h2 class="text-2xl font-bold text-white mb-2 flex items-center">
            <i class="fas fa-sync-alt mr-3"></i> Manage Product Group Status (Obsolete/Unobsolete)
        </h2>
        <p class="text-emerald-100">Toggle the active status of product groups.</p>
    </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 bg-white">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr v-if="filteredProductGroups.length === 0">
                        <td colspan="4" class="px-6 py-4 text-center text-gray-500">No product groups found.</td>
                    </tr>
                </tbody>
            </table>
        </div>
