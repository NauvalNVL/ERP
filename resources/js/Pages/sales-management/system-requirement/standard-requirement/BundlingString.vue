                    ...
                    <div class="bg-white shadow-sm rounded-xl border border-violet-100">
                        ...
                        <div class="px-4 py-4 sm:px-5">
                            <div class="grid grid-cols-1 gap-3">
                                <Link href="/wrapping-material" class="flex items-center p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors border border-purple-100">
                                ...
                                <Link href="/stitch-wire" class="flex items-center p-3 bg-sky-50 rounded-lg hover:bg-sky-100 transition-colors border border-sky-100">
                                ...
                                <Link href="/bundling-string/view-print" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors border border-emerald-100">
                                    <div class="p-2 bg-emerald-500 rounded-full mr-3">
                                        <i class="fas fa-print text-white text-sm"></i>
                                    </div>
                                    <div>
                                        <p class="font-medium text-emerald-900 text-sm">Print List</p>
                                        <p class="text-xs text-emerald-700">Print bundling string list</p>
                                    </div>
                                </Link>
                            </div>
                        </div>
            ...
            <div class="p-5">
                <form @submit.prevent="saveBundlingStringChanges" class="space-y-4">
                    ...
                    <div class="flex justify-between mt-5 pt-4 border-t border-gray-200">
                        <button type="button" v-if="!isCreating" @click="deleteBundlingString(editForm.id)" class="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 text-sm font-medium">
