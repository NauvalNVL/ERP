                    ...
                    <div class="bg-white shadow-sm rounded-xl border border-violet-100">
                        ...
                        <div class="px-4 py-4 sm:px-5">
                            <div class="grid grid-cols-1 gap-3">
                                <Link href="/color" class="flex items-center p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors border border-purple-100">
                                ...
                                <Link href="/color-group" class="flex items-center p-3 bg-sky-50 rounded-lg hover:bg-sky-100 transition-colors border border-sky-100">
                                    <div class="p-2 bg-sky-500 rounded-full mr-3">
                                        <i class="fas fa-layer-group text-white text-sm"></i>
                                    </div>
                                    <div>
                                        <p class="font-medium text-sky-900 text-sm">Color Groups</p>
                                        <p class="text-xs text-sky-700">View color groups</p>
                                    </div>
                                </Link>

                                <Link href="/vue/finishing/view-print" class="flex items-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors border border-emerald-100">
                                    <div class="p-2 bg-emerald-500 rounded-full mr-3">
                                        <i class="fas fa-print text-white text-sm"></i>
                                    </div>
                                    <div>
                                        <p class="font-medium text-emerald-900 text-sm">Print List</p>
                                        <p class="text-xs text-emerald-700">Print finishing list</p>
                                    </div>
                                </Link>
                            </div>
                        </div>
