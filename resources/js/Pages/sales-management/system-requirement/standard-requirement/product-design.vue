          ...
          <div class="px-4 py-3 sm:px-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs sm:text-sm text-green-100">
                Define product designs for product categorization
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
              ...
              >
                ...
                >
                  <p class="text-sm font-medium text-yellow-800">
                    No product design data available.
                  </p>
                ...
                <div v-else class="mt-4 bg-green-100 p-3 rounded">
                  <p class="text-sm font-medium text-green-800">
                    Data available: {{ designs.length }} designs found.
                  </p>
                  <p v-if="selectedRow" class="text-xs text-green-700 mt-1">
                    Selected:
                    <span class="font-semibold">{{ selectedRow.pd_code }}</span> -
                    {{ selectedRow.pd_name }}
                  </p>
                </div>
              </div>
...
watch(searchQuery, (newQuery) => {
  if (newQuery && designs.value.length > 0) {
    const foundDesign = designs.value.find(
      (design) =>
