    ...
    <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-blue-500">
        <div class="flex items-center mb-6 pb-2 border-b border-gray-200">
            ...
            <h3 class="text-xl font-semibold text-gray-800">
                {{ isset($editCurrency) ? 'Edit Currency' : 'Add New Currency' }}
            </h3>
        </div>
        ...
        >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                {{-- Currency Code with Button --}}
                <div>
                    <label for="currency_code" class="block text-gray-700 text-sm font-bold mb-1">Currency Code:</label>
                    <div class="flex">
                        <input type="text" id="currency_code" name="currency_code" 
                               value="{{ old('currency_code', $editCurrency->currency_code ?? '') }}" 
                               class="shadow-sm appearance-none border rounded-l w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 @error('currency_code') border-red-500 @enderror" 
                               maxlength="3" required {{ isset($editCurrency) ? 'readonly bg-gray-100' : '' }} placeholder="e.g., USD">
                        <button type="button" onclick="openCurrencyModal()" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-3 rounded-r inline-flex items-center">
                ...
                <div>
                    ...
                    <input type="text" id="country" name="country" 
                           ...
                           class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 @error('country') border-red-500 @enderror" 
                ...
                <div class="md:col-span-2">
                    <label for="currency_name" class="block text-gray-700 text-sm font-bold mb-1">Currency Name:</label>
                    <input type="text" id="currency_name" name="currency_name" 
                           value="{{ old('currency_name', $editCurrency->currency_name ?? '') }}" 
                           class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 @error('currency_name') border-red-500 @enderror" 
                ...
                {{-- Exchange Rate --}}
                <div>
                    <label for="exchange_rate" class="block text-gray-700 text-sm font-bold mb-1">Exchange Rate:</label>
                    <input type="number" id="exchange_rate" name="exchange_rate" step="0.000001" 
                           ...
                           class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 @error('exchange_rate') border-red-500 @enderror" 
                ...
                {{-- Exchange Method --}}
                <div>
                    <label class="block text-gray-700 text-sm font-bold mb-1">Exchange Method:</label>
                    <div class="flex items-center mt-2 space-x-4">
                        <label for="method_multiply" class="flex items-center text-sm">
                            <input type="radio" id="method_multiply" name="exchange_method" value="1" 
                                   class="mr-2 leading-tight focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300" {{ old('exchange_method', $editCurrency->exchange_method ?? 1) == 1 ? 'checked' : '' }}>
                            Multiply
                        </label>
                        <label for="method_divide" class="flex items-center text-sm">
                            <input type="radio" id="method_divide" name="exchange_method" value="2" 
                                   class="mr-2 leading-tight focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300" {{ old('exchange_method', $editCurrency->exchange_method ?? 1) == 2 ? 'checked' : '' }}>
                            Divide
                        </label>
                    </div>
                ...
                {{-- Variance Control --}}
                <div>
                    <label for="variance_control" class="block text-gray-700 text-sm font-bold mb-1">Variance Control (%):</label>
                    <input type="number" id="variance_control" name="variance_control" step="0.01" min="0" max="100" 
                           ...
                           class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 @error('variance_control') border-red-500 @enderror" 
                           required>
                ...
                {{-- Max Tax Adj --}}
                <div>
                    <label for="max_tax_adj" class="block text-gray-700 text-sm font-bold mb-1">Max +/- Tax ADJ:</label>
                    <input type="number" id="max_tax_adj" name="max_tax_adj" step="0.01" 
                           ...
                           class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 @error('max_tax_adj') border-red-500 @enderror" 
                           required>
                    @error('max_tax_adj')
                        <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                    @enderror
            ...
            <div class="flex items-center justify-end mt-6 pt-4 border-t border-gray-200">
                @if(isset($editCurrency))
                    <a href="{{ route('foreign-currency.index') }}" 
                       class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mr-2 transition-colors duration-150 ease-in-out">
                        Cancel
                    </a>
                    <button type="submit" 
                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition-colors duration-150 ease-in-out flex items-center">
                        <i class="fas fa-save mr-2"></i> Update
                    </button>
                @else
                     {{-- Add a Reset button for the add form --}}
                     <button type="reset" 
                            class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mr-2 transition-colors duration-150 ease-in-out">
                        Reset
                    </button>
                    <button type="submit" 
                            class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition-colors duration-150 ease-in-out flex items-center">
