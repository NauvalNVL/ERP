        ...
        <form method="POST" action="{{ route('system-configuration.update') }}" class="space-y-6">
            ...
            <div class="pt-6 border-t mt-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="p-4 border rounded-md hover:border-blue-500 transition-colors cursor-pointer">
                        <div class="flex items-center space-x-3">
                            <div class="{{ $item['color'] }} p-2 rounded-lg">
            ...
            <div class="pt-8">
                <button type="submit" 
                    class="w-full md:w-auto px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md shadow-sm transition-colors">
