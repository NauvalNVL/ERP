            ...
            <div class="bg-white p-6 rounded-lg shadow-md border-t-4 border-blue-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                    <div class="col-span-2">
                        ...
                        <div class="relative flex">
                            ...
                            <input type="text" id="geoCode" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none border border-gray-300 focus:ring-blue-500 focus:border-blue-500 transition-colors" placeholder="Masukkan Kode Geo" onkeyup="searchGeoCode(this.value)">
                            <button type="button" id="showGeoTableBtn" class="inline-flex items-center px-3 py-2 border border-l-0 border-gray-300 bg-blue-500 hover:bg-blue-600 text-white rounded-r-md transition-colors transform active:translate-y-px" onclick="toggleModal('geoModal')">
                ...
                <div class="mt-4 bg-yellow-100 p-3 rounded">
                    ...
                    <div class="mt-2 flex items-center space-x-3">
                        <a href="{{ route('geo.index') }}" class="bg-blue-500 hover:bg-blue-600 text-white text-xs px-3 py-1 rounded transform active:translate-y-px">
                            Run Geo Seeder (DB)
                        </a>
                ...
                <div class="mt-4 bg-green-100 p-3 rounded">
                    <p class="text-sm font-medium text-green-800">Data tersedia: {{ count($geoData) }} geo ditemukan.</p>
                </div>
                @endif
            </div>
        </div>
...
<!-- Geo Table Window -->
<div id="geoModal" class="hidden fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-xl w-11/12 md:w-3/4 lg:w-2/3 max-w-5xl mx-auto transform transition-transform duration-300" style="max-height: 80vh;">
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-t-lg">
            ...
            <button type="button" onclick="toggleModal('geoModal')" class="text-white hover:text-gray-200 focus:outline-none transform active:translate-y-px">
        ...
        <div class="p-5 overflow-auto" style="max-height: calc(80vh - 130px);">
            ...
            <div class="overflow-x-auto rounded-lg border border-gray-200">
                <table class="min-w-full divide-y divide-gray-200" id="geoDataTable">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 text-xs" id="geoTableBody">
                        ...
                        @else
                            <tr>
                                <td colspan="7" class="px-4 py-4 text-center text-gray-500">Tidak ada data geo yang tersedia.</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
            ...
            <div class="mt-4 grid grid-cols-3 gap-2">
                <button type="button" class="py-2 px-3 bg-gray-100 border border-gray-400 hover:bg-gray-200 text-xs rounded-lg transform active:translate-y-px">
                    <i class="fas fa-sort mr-1"></i>By Code
                </button>
                <button type="button" class="py-2 px-3 bg-gray-100 border border-gray-400 hover:bg-gray-200 text-xs rounded-lg transform active:translate-y-px">
                    <i class="fas fa-sort mr-1"></i>By Country
                </button>
                <button type="button" id="selectGeoBtn" onclick="selectGeo()" class="py-2 px-3 bg-blue-500 hover:bg-blue-600 text-white text-xs rounded-lg transform active:translate-y-px">
...
<!-- Edit Geo Modal -->
<div id="editGeoModal" class="hidden fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-xl w-11/12 md:w-2/5 max-w-md mx-auto transform transition-transform duration-300">
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-t-lg">
            ...
            <button type="button" onclick="toggleModal('editGeoModal')" class="text-white hover:text-gray-200 focus:outline-none transform active:translate-y-px">
                <i class="fas fa-times text-xl"></i>
            </button>
        </div>
        ...
        <div class="p-6">
            <form id="editGeoForm" class="space-y-4">
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        <label for="editGeoCode" class="block text-sm font-medium text-gray-700 mb-1">Geo Code:</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500">
                                <i class="fas fa-hashtag"></i>
                            </span>
                            <input id="editGeoCode" type="text" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="editCountry" type="text" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="editState" type="text" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="editTown" type="text" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                        </div>
                    </div>
                    
                    <div>
                        <label for="editTownSection" class="block text-sm font-medium text-gray-700 mb-1">Town Section:</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500">
                                <i class="fas fa-map-marker-alt"></i>
                            </span>
                            <input id="editTownSection" type="text" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                        </div>
                    </div>
                    
                    <div>
                        <label for="editGeoArea" class="block text-sm font-medium text-gray-700 mb-1">Geo Area:</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500">
                                <i class="fas fa-globe-asia"></i>
                            </span>
                            <input id="editGeoArea" type="text" class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm">
                        </div>
                    </div>
                ...
                <div class="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-200">
                    <button type="button" onclick="toggleModal('editGeoModal')" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors text-sm transform active:translate-y-px">
                        <i class="fas fa-times mr-2"></i>Cancel
                    </button>
                    <button id="btnReview" type="button" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm transform active:translate-y-px">
...
<!-- Review Geo Modal -->
<div id="reviewGeoModal" class="hidden fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-xl w-11/12 md:w-2/5 max-w-md mx-auto transform transition-transform duration-300">
        <!-- Modal Header - Title Bar -->
        <div class="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-t-lg">
            ...
            <button type="button" onclick="toggleModal('reviewGeoModal')" class="text-white hover:text-gray-200 focus:outline-none transform active:translate-y-px">
                <i class="fas fa-times text-xl"></i>
            </button>
                    </div>
        ...
        <div class="p-6">
            ...
            <div class="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-200">
                <button type="button" onclick="toggleModal('reviewGeoModal')" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors text-sm transform active:translate-y-px">
                    <i class="fas fa-arrow-left mr-2"></i>Kembali
                </button>
                <button type="button" onclick="confirmAndSave()" class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors text-sm transform active:translate-y-px">
