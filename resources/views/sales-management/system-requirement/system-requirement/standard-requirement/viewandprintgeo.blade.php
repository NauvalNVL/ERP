...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6 print:hidden">
        <h1 class="text-2xl font-semibold text-gray-700">View & Print Geo</h1>
        <button 
            ...
            <tbody>
                @forelse ($geos as $geo)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                            {{ $geo->created_at ? $geo->created_at->format('Y-m-d H:i:s') : 'N/A' }}
                        </td>
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                            {{ $geo->updated_at ? $geo->updated_at->format('Y-m-d H:i:s') : 'N/A' }}
                        </td>
                    </tr>
                @empty
                    <tr>
