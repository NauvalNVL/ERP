            ...
            <tbody>
                @forelse ($salesTeams as $team)
                    <tr class="hover:bg-gray-50">
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">{{ $team->id }}</td>
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">{{ $team->code ?? 'N/A' }}</td>
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">{{ $team->name ?? 'N/A' }}</td>
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">{{ $team->created_at ? $team->created_at->format('Y-m-d H:i:s') : 'N/A' }}</td>
                        <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">{{ $team->updated_at ? $team->updated_at->format('Y-m-d H:i:s') : 'N/A' }}</td>
                    </tr>
                @empty
                    <tr>
