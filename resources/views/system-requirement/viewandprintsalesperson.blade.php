        ...
        <table class="min-w-full leading-normal">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="px-3 py-3 border-b-2 border-gray-200 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Sales Team</th>
                    <th class="px-3 py-3 border-b-2 border-gray-200 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Position</th>
                    <th class="px-3 py-3 border-b-2 border-gray-200 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">User ID</th>
            ...
            <tbody>
                @forelse ($salespersons as $person)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-3 py-4 border-b border-gray-200 bg-white text-sm">{{ $person->salesTeam->name ?? ($person->sales_team_id ?? 'N/A') }}</td>
                        ...
                        <td class="px-3 py-4 border-b border-gray-200 bg-white text-sm">{{ $person->is_active ? 'Yes' : 'No' }}</td>
                        <td class="px-3 py-4 border-b border-gray-200 bg-white text-sm">{{ $person->created_at ? $person->created_at->format('Y-m-d H:i:s') : 'N/A' }}</td>
                        <td class="px-3 py-4 border-b border-gray-200 bg-white text-sm">{{ $person->updated_at ? $person->updated_at->format('Y-m-d H:i:s') : 'N/A' }}</td>
                    </tr>
                @empty
                    <tr>
