...
<button @click="$store.sidebar.toggleMobile()" class="lg:hidden fixed top-4 left-4 z-50 p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
...
<!-- Sidebar -->
<div class="flex flex-col h-full bg-gray-800 text-white fixed lg:static inset-y-0 left-0 transform lg:transform-none transition duration-200 ease-in-out z-40 w-64"
     :class="{'translate-x-0': $store.sidebar.mobileOpen, '-translate-x-full': !$store.sidebar.mobileOpen}">
...
<!-- Add CSS for hide-scrollbar utility and responsive styles -->
<style>
