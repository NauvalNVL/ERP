...
return new class extends Migration
{
    ...
    {
        Schema::create('DO_NEW', function (Blueprint $table) {
            ...
            $table->string('MC_Net_Kg_Per_Pcs', 30)->nullable()->collation('SQL_Latin1_General_CP1_CI_AS'); // DataType 28 (Unicode)
            $table->decimal('Total_DO_Gross_KG', 15, 2)->nullable(); // DataType 12
            $table->decimal('Total_DO_Net_KG', 15, 2)->nullable(); // DataType 12
            // $table->integer('DODateSK')->nullable(); // DataType 3 - Kolom ini tidak ada di struktur DO_NEW
