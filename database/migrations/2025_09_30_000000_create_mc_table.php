...
return new class extends Migration
{
	...
	public function up(): void
	{
		Schema::create('MC', function (Blueprint $table) {
			...
			// Numeric columns (using decimal for flexibility)
			$table->decimal('INT_LENGTH', 18, 4)->nullable();
			$table->decimal('INT_WIDTH', 18, 4)->nullable();
			$table->decimal('INT_HEIGHT', 18, 4)->nullable();
			$table->decimal('EXT_LENGTH', 18, 4)->nullable();
			$table->decimal('EXT_WIDTH', 18, 4)->nullable();
			$table->decimal('EXT_HEIGHT', 18, 4)->nullable();
			$table->decimal('SHEET_LENGTH', 18, 4)->nullable();
			$table->decimal('SHEET_WIDTH', 18, 4)->nullable();
			$table->decimal('PAPER_SIZE', 18, 4)->nullable();
			$table->decimal('CORR_OUT', 18, 4)->nullable();
			$table->decimal('SLIT_OUT', 18, 4)->nullable();
			$table->decimal('DIE_OUT', 18, 4)->nullable();
			$table->decimal('JOIN_', 18, 4)->nullable();
			$table->decimal('NEST_SLOT', 18, 4)->nullable();
			$table->decimal('CREASE', 18, 4)->nullable();
			$table->decimal('SL1', 18, 4)->nullable();
			$table->decimal('SL2', 18, 4)->nullable();
			$table->decimal('SL3', 18, 4)->nullable();
			$table->decimal('SL4', 18, 4)->nullable();
			$table->decimal('SL5', 18, 4)->nullable();
			$table->decimal('SL6', 18, 4)->nullable();
			$table->decimal('SL7', 18, 4)->nullable();
			$table->decimal('SL8', 18, 4)->nullable();
			$table->decimal('TOTAL_SL', 18, 4)->nullable();
			$table->decimal('SW1', 18, 4)->nullable();
			$table->decimal('SW2', 18, 4)->nullable();
			$table->decimal('SW3', 18, 4)->nullable();
			$table->decimal('SW4', 18, 4)->nullable();
			$table->decimal('SW5', 18, 4)->nullable();
			$table->decimal('SW6', 18, 4)->nullable();
			$table->decimal('SW7', 18, 4)->nullable();
			$table->decimal('SW8', 18, 4)->nullable();
			$table->decimal('TOTAL_SW', 18, 4)->nullable();
			$table->decimal('COLOR1_AREA_PERCENT', 18, 4)->nullable();
			$table->decimal('COLOR2_AREA_PERCENT', 18, 4)->nullable();
			$table->decimal('COLOR3_AREA_PERCENT', 18, 4)->nullable();
			$table->decimal('COLOR4_AREA_PERCENT', 18, 4)->nullable();
			$table->decimal('COLOR5_AREA_PERCENT', 18, 4)->nullable();
			$table->decimal('COLOR6_AREA_PERCENT', 18, 4)->nullable();
			$table->decimal('COLOR7_AREA_PERCENT', 18, 4)->nullable();
			$table->decimal('DC_SHT_L', 18, 4)->nullable();
			$table->decimal('DC_SHT_W', 18, 4)->nullable();
			$table->decimal('DC_MOULD_L', 18, 4)->nullable();
			$table->decimal('DC_MOULD_W', 18, 4)->nullable();
			$table->decimal('SWIRE_PCS', 18, 4)->nullable();
			$table->decimal('PEEL_OFF_PERCENT', 18, 4)->nullable();
			$table->decimal('PCS_PER_BLD', 18, 4)->nullable();
			$table->decimal('STRING_TYPE_VALUE')->nullable(); // optional numeric variant if needed
			$table->decimal('BLD_PER_PLD', 18, 4)->nullable();
			$table->decimal('PCS_SET', 18, 4)->nullable();
			...
			$table->decimal('TOTAL_COLOR', 18, 4)->nullable();
		});
	}
